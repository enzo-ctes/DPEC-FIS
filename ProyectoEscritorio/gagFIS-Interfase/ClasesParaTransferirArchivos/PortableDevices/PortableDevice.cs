...
namespace PortableDevices
{
    public class PortableDevice
    {
        ...
        public void TransferContentToDevice(string fileName, string parentObjectId)
        {
            ...
            Console.Write(optimalTransferSizeBytes);

            content.CreateObjectWithPropertiesAndData(values, out tempStream, ref optimalTransferSizeBytes, null);
            //CreateObjectWithPropertiesAndData(IPortableDeviceValues pValues, out IStream ppData, ref uint pdwOptimalWriteBufferSize, ref string ppszCookie);
            try
            {
