    ...
    private void splitContainer1_Panel2_Paint(object sender, PaintEventArgs e)
      ...
      txSQL = "INSERT INTO ConceptosDatos ([conexionID], [Periodo], [CodigoConcepto], [CodigoEscalon], [CodigoAux], [CodigoGrupo], [TextoEscalon]," +
                                        ...
                                        using (StreamReader sr = new StreamReader(files.DirectoryName + "\\InfoCarga.txt", false))
                                            {
                                               ...
                                               while ((line = sr.ReadLine()) != null)
                                               {
                                                  ...
                                                  Vble.lineas += line + "- Colectora: " + cmbDevices.Text +"\n";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                MessageBox.Show(Vble.CarpetaRespaldo + Vble.RespaldoEnviadas + "\\InfoCarga.txt" );
                                ...
                                {                                  
                                    ...
                                    foreach (var destino in carpeta)
                                    {
                                        ...
                                        if (destino.DisplayName == Vble.CarpetaDestinoColectora)
                                        {
                                            ...
                                            string Dispositivo = BuscarNombreColectora(Vble.DirectorioColectoraenPC);
                                            Vble.Colectora = Dispositivo + cmbDevices.Text + "\\" + Vble.CarpetaDestinoColectora + "\\";
                                            ...
                                            if (File.Exists(Ruta+ArchivoBase))
                                            {
                                                ...
                                                MessageBox.Show("La Colectora ya contiene la Carga: " + LeerArchivostxt(Ruta + "InfoCarga.txt") +"\nPor favor primero realice la descarga para volver a enviar otro Archivo", "Atención", MessageBoxButtons.OKCancel, MessageBoxIcon.Information);
        ...
        private string LeerArchivostxt(string RutaArchivo)
        {
