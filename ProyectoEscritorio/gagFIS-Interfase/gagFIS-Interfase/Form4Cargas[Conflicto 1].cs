                    ...
                    if (Nodo.Level == 4)                       
                     {
                        ...
                        //if (Nodo.ImageKey == "todo")
                        // {                           
                        // MessageBox.Show("se selecciono");
                        // clave = Nodo.Tag.ToString();
        ...
        {                   
            ...
            try
            {
                txSQL = "select C.Secuencia as Nº_Secuencia, C.conexionID as Nº_Conexion, L.CodigoInt as Cod_Localidad, C.Ruta, C.usuarioID , P.Apellido, C.titularID, P.Apellido, C.propietarioID, P.apellido " +
                        ...
                        "Where (C.Secuencia >= " + ArrayDesde[0].ToString() + " and C.Secuencia <= " + ArrayHasta[0].ToString() + " and C.Ruta = " + Ru.Text + " and L.CodigoInt = " + Loc.Text + " and C.ImpresionOBS = " + 0 + ")"; //" or C.Secuencia >= " +  445513 + " and C.Secuencia <= " + 446720 + " and C.Ruta = " + 1169 + " and C.ImpresionOBS = " + 0 + ")";               
        ...
        private DataTable CargarRegistrosSecuencia2()
        {
            ...
            try
            {
                txSQL = "select C.Secuencia as Nº_Secuencia, C.conexionID as Nº_Conexion, L.CodigoInt as Cod_Localidad, C.Ruta, C.usuarioID , P.Apellido, C.titularID, P.Apellido, C.propietarioID, P.apellido " +
                        ...
                        "INNER JOIN localidades L ON L.CodigoPostal = C.CodPostalSumin " +
                        //"INNER JOIN conceptosdatos D on C.conexionID = D.conexionID " +
                        "Where (C.Secuencia >= " + ArrayDesde[0].ToString() + " and C.Secuencia <= " + ArrayHasta[0].ToString() + " and C.Ruta = " + ArrayRuta[0].ToString() + " and L.CodigoInt = " + Loc.Text + " and C.ImpresionOBS = " + 0 +  " or C.Secuencia >= " +  ArrayDesde[1].ToString() + " and C.Secuencia <= " + ArrayHasta[1].ToString() + " and C.Ruta = " + ArrayRuta[1] + " and C.ImpresionOBS = " + 0 + ")";               
