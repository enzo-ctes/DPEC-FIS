...
namespace gagFIS_Interfase
{
    ...
    public partial class Form3Descargas : Form {
            ...
            try
            {
                ...
                if (Tabla.Rows.Count > 0)
                {
                    ...
                    PdfWriter.GetInstance(document,
                                  new FileStream(PathInformes + "\\Informe Periodo " + Vble.Periodo + "_Hora" + DateTimeOffset.Now.ToString("HHmmss") + ".pdf",
                                         FileMode.OpenOrCreate));
                    document.Open();

                    Chunk chunk = new Chunk("Informe de Descargas pertenecientes al Periodo: " + periodo + "\n\n", FontFactory.GetFont("Arial", 19, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.LIGHT_GRAY));
                    document.Add(new Paragraph(chunk));
                    document.Add(new Paragraph("Fecha: " + DateTime.Today.ToString("dd/MM/yyyy"), FontFactory.GetFont("Arial", 10, iTextSharp.text.Font.NORMAL)));
                    document.Add(new Paragraph("Operario: Ramirez Enzo Martin", FontFactory.GetFont("Arial", 10, iTextSharp.text.Font.NORMAL)));

                    document.Add(new Paragraph("Total de Conexiones Descargadas del periodo: " + TotalGeneral + "\n", FontFactory.GetFont("Arial", 14, iTextSharp.text.Font.BOLD)));
                    document.Add(new Paragraph("Resumenes por Descargas: ", FontFactory.GetFont("Arial", 14, iTextSharp.text.Font.BOLD)));
                    ...
                    foreach (DataRow fi in Tabla.Rows)
                    {
                        if (fi[1].ToString() == periodo.ToString())
                        {
                            ...
                            document.Add(new Paragraph("Descarga: " + fi[3].ToString(), FontFactory.GetFont("Arial", 10, iTextSharp.text.Font.BOLD)));
                            document.Add(new Paragraph("Información de la descarga:", FontFactory.GetFont("Arial", 8, iTextSharp.text.Font.NORMAL)));
                            document.Add(new Paragraph(fi[6].ToString(), FontFactory.GetFont("Arial", 8, iTextSharp.text.Font.NORMAL)));
                            document.Add(new Paragraph("Cantidad Conexiones: " + fi[7].ToString(), FontFactory.GetFont("Arial", 8, iTextSharp.text.Font.NORMAL)));
                            document.Add(new Paragraph("Estado de Conexiones luego de terminar el recorrido:", FontFactory.GetFont("Arial", 8, iTextSharp.text.Font.NORMAL)));
                            document.Add(new Paragraph("        Leidas e Impresas: " + fi[10].ToString(), FontFactory.GetFont("Arial", 8, iTextSharp.text.Font.NORMAL)));
                            document.Add(new Paragraph("        Leidas NO Impresas: " + fi[8].ToString(), FontFactory.GetFont("Arial", 8, iTextSharp.text.Font.NORMAL)));
                            document.Add(new Paragraph("        NO Impresas Impresora Desconectada: " + fi[11].ToString(), FontFactory.GetFont("Arial", 8, iTextSharp.text.Font.NORMAL)));
                            document.Add(new Paragraph("        NO Impresas Fuera de Rango: " + fi[12].ToString(), FontFactory.GetFont("Arial", 8, iTextSharp.text.Font.NORMAL)));
                            document.Add(new Paragraph("        NO Impresas Estado Negativo: " + fi[13].ToString(), FontFactory.GetFont("Arial", 8, iTextSharp.text.Font.NORMAL)));
                            document.Add(new Paragraph("        NO Impresas Error Dato: " + fi[14].ToString(), FontFactory.GetFont("Arial", 8, iTextSharp.text.Font.NORMAL)));
                            document.Add(new Paragraph("        NO Impresas Domicilio Postal: " + fi[15].ToString(), FontFactory.GetFont("Arial", 8, iTextSharp.text.Font.NORMAL)));
                            document.Add(new Paragraph("        NO Impresas Indicado Dato: " + fi[16].ToString(), FontFactory.GetFont("Arial", 8, iTextSharp.text.Font.NORMAL)));
                            document.Add(new Paragraph("        Imposible Leer: " + fi[17].ToString(), FontFactory.GetFont("Arial", 8, iTextSharp.text.Font.NORMAL)));
                            document.Add(new Paragraph("        Sub Total Negativo: " + fi[18].ToString(), FontFactory.GetFont("Arial", 8, iTextSharp.text.Font.NORMAL)));
                            document.Add(new Paragraph("        Error al Archivar Datos: " + fi[19].ToString(), FontFactory.GetFont("Arial", 8, iTextSharp.text.Font.NORMAL)));
                            document.Add(new Paragraph("        Error en Nº de Factura: " + fi[20].ToString(), FontFactory.GetFont("Arial", 8, iTextSharp.text.Font.NORMAL)));
                            document.Add(new Paragraph("        Sin Conceptos a Facturar: " + fi[21].ToString(), FontFactory.GetFont("Arial", 8, iTextSharp.text.Font.NORMAL)));
                            document.Add(new Paragraph("        Error al Facturar: " + fi[22].ToString(), FontFactory.GetFont("Arial", 8, iTextSharp.text.Font.NORMAL)));
                            document.Add(new Paragraph("        Periodo Excedido en Días: " + fi[23].ToString(), FontFactory.GetFont("Arial", 8, iTextSharp.text.Font.NORMAL)));
                    ...
                    //document.Add(new Paragraph(Vble.lineas, FontFactory.GetFont("Arial", 12, iTextSharp.text.Font.NORMAL)));
                    document.Close();
        ...
        {
            MessageBox.Show(DateTimeOffset.Now.ToString("HHmmss"));
        }
    }
}
